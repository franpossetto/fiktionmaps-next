...
function statusBadgeClass(status: PlaceContributionFeedItem["status"]): string {
  switch (status) {
    case "pending":
...
export interface StaffPlaceContributionReviewRightAsideProps {
  item: PlaceContributionFeedItem
  moderatorWho: string | null
}

export async function StaffPlaceContributionReviewRightAside({
  item,
  moderatorWho,
}: StaffPlaceContributionReviewRightAsideProps) {
