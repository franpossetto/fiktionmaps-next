        ...
        <PageStickyBar
          ...
          leading={
            <button
              ...
              aria-label="Back to scenes list"
            >
          ...
          title={
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-muted-foreground">
                {fiction?.title || "Scene"}{currentWatchScene.timestamp ? ` • ${currentWatchScene.timestamp}` : ""}
              </p>
            </div>
          }
        />
